...
namespace Karamem0.Kanpuchi.ViewModels {
    ...
    /// <summary>
    /// まとめ記事を表示するピボット ページのビュー モデルを表します。
    /// </summary>
    public class MatomeViewModel : ViewModel {

        /// <summary>
        /// まとめ記事を管理するサービスを取得します。
        /// </summary>
        public MatomeEntryService Service { get; private set; }

        /// <summary>
        /// 最新のまとめ記事を読み込むコマンドを取得します。
        /// </summary>
        public DelegateCommand LoadLatestCommand { get; set; }

        /// <summary>
        /// 前のまとめ記事を読み込むコマンドを取得します。
        /// </summary>
        ...
        /// <summary>
        /// <see cref="Karamem0.Kanpuchi.ViewModels.MatomeViewModel"/> クラスの新しいインスタンスを初期化します。
        /// </summary>
        public MatomeViewModel() {
            this.Service = new MatomeEntryService();
