...
<head>
    ...
    <title>MatomeEntry API テスト</title>
...
<body>
    <div class="container">
        ...
        <form id="request-query" class="form-horizontal">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label" for="siteid">siteid</label>
                <div class="col-sm-10">
                    <input type="number" id="siteid" name="siteid" class="form-control" />
                </div>
            </div>
            <div class="form-group">
    ...
    <script type="text/javascript">
        $(function () {
            $("#button").click(function () {
                ...
                $.ajax({
                    type: "GET",
                    url: encodeURI("/api/matomeentry?" + $("#request-query").serialize()),
